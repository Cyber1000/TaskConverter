...
namespace TaskConverter.Plugin.GTD.TodoModel
{
    ...
    public readonly struct KeyWordMetaData(int id, string name, KeyWordType keyWordType, IDateTime created, IDateTime modified, Color color) : IEquatable<KeyWordMetaData>
    {
